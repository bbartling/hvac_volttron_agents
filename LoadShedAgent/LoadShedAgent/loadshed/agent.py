			...
			"intervals": [
				{
                    ...
                    "dtstart": dt(2022, 6, 12, 19, 30, tzinfo=tz.utc),
					"signal_payload": 1.0,
					"uid": 0
				}
			],
...
class Loadshed(Agent):
    ...
    def bacnet_override_go(self):
        ...
        for obj,setpoint in zone_setpoints_data_request[0].items():
            ...
            if int(dev_address) in vendor1_range and self.vendor1_reheat_valves_topic is not None:
                reheat_valve_name = self.vendor1_reheat_valves_topic
            ...
            elif int(dev_address) in vendor2_range and self.vendor2_reheat_valves_topic is not None:
                reheat_valve_name = self.vendor2_reheat_valves_topic
            ...
            # dont add a reheat coil to data structures write_to_bas or log_of_points_written
            else:
                pass
    ...
    def event_checkr(self):
        ...
        # HVAC system is successfully overridden without exception errors
            ...
            _log.info(f'[Simple DR Agent INFO] - The Last Event On ... Had Status Of ...')
